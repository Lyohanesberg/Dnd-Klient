...
## Етап 4: Мультимедіа та Імерсивність
...
2.  **Аудіо супровід:**
    *   [ ] Фонова музика (Ambient) залежно від ситуації (Бій, Відпочинок).
    *   [ ] SFX (Звукові ефекти) для кидків кубиків та повідомлень.
    *   [ ] TTS (Text-to-Speech) для озвучування реплік ДМ-а.

## ✅ Етап 5: Інфраструктура (Backend) — ВИКОНАНО
*Мета: Грати будь-де.*

1.  **Хмарне збереження (Google Drive):**
...
## Етап 6: Спільні пригоди
*Мета: Мультиплеєр.*

1.  **Спільні сесії:**
    *   [ ] Можливість мультиплеєру (кілька гравців в одному чаті).
